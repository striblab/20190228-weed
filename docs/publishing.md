...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190228-weed">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190228-weed/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190228-weed/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190228-weed/",
      "url": "http://static.startribune.com/news/projects/all/20190228-weed/"
    }
  }
}
```
